...
* [Learn Python with Tests](gb-readme.md)

## Getting started

* [Install Python & tooling](install-python.md)
* [Why TDD for interviews](why-tdd-for-interviews.md)
* [How to study with this book](how-to-study.md)
...
* [Dijkstra & weighted graphs](dijkstra.md)
* [Heap / Priority Queue](heaps.md)
* [Greedy](greedy.md)
* [DP: 1D](dp-1d.md)
* [DP: Grid](dp-grid.md)
* [DP: Knapsack](dp-knapsack.md)
* [DP: Intervals and sequences](dp-intervals.md)
* [Trie](trie.md)
