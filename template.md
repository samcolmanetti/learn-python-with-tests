...
1. `# [Chapter title]`
2. `**[You can find all the code for this chapter here](https://github.com/USER/python-with-tests/tree/main/CHAPTER_FOLDER)**`
...
- `uv` commands in prose: `uv run pytest`, `uv sync`.
- Standard library only in solution code. Tests are `test_*.py` with package-relative imports.
