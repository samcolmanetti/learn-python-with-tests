...
**[You can find all the code for this chapter here](https://github.com/samcolmanetti/learn-python-with-tests/tree/main/code/internet_http)**
...
```
ImportError: cannot import name 'fetch_json' from 'http_client'
```
...
```
ImportError: cannot import name 'get_user_name' from 'http_client'
```
