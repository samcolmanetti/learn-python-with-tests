...
# Root-level markdown that is intentionally NOT a SUMMARY chapter.
NON_CHAPTER_MARKDOWN = {
    "README.md",      # GitHub landing page (uses gb-readme.md as the in-book readme)
...
def test_no_orphan_root_chapters():
    ...
    assert not orphans, (
        "These root-level chapters are not reachable from SUMMARY.md "
