...
**[You can find all the code for this chapter here](https://github.com/samcolmanetti/learn-python-with-tests/tree/main/mocking)**
...
def test_describe_channel_with_patch():
    with patch("mocking.reminders.default_channel", return_value="ops"):
